...
<?php
    ...
    $sql = "SELECT distinct p_id,problemlist.c_id,contests.contestname,probname,maxmark FROM contests,problemlist where problemlist.c_id = contests.c_id";
                                    ...
                                    if ($result->num_rows > 0) {
                                        while($row = $result->fetch_assoc()){
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center">'.$row['probname'].'</td>
                                                <td class="center">'.$row['maxmark'].'</td>
                                            </tr>
                                            ';
                                        }
                                    }
